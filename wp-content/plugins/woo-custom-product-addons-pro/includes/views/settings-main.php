                                        ...
                                        <div class="options_group">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <input type="checkbox" name="wcpa_disable_validation_scroll" id="wcpa_disable_validation_scroll"
                                                           value="1" <?php checked(wcpa_get_option('wcpa_disable_validation_scroll', false)); ?>>
                                                    <label for="wcpa_disable_validation_scroll" class="text">
                                                        <?php _e('Disable scrolling to error field on validation', 'wcpa-text-domain'); ?>
                                                        <br>
                                                        <small class="label"><?php _e('You can disable scrolling behaviour of page on form validation.', 'wcpa-text-domain'); ?> </small>
                                                    </label>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="options_group">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <input type="checkbox" name="wcpa_show_val_error_box" id="wcpa_show_val_error_box"
                                                           value="1" <?php checked(wcpa_get_option('wcpa_show_val_error_box', false)); ?>>
                                                    <label for="wcpa_show_val_error_box" class="text">
                                                        <?php _e('Show validation error after the form', 'wcpa-text-domain'); ?>
                                                        <br>
                                                        <small class="label"><?php _e('You can show the validation error after the form in a single section.', 'wcpa-text-domain'); ?> </small>
                                                    </label>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div id="wcpa_advanced_settings" class="wcpa_tabcontent" style="display: none">
                                        <div class="options_group">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <input type="checkbox" name="enable_map_to_checkout" id="enable_map_to_checkout"
                                                        value="1" <?php checked(wcpa_get_option('enable_map_to_checkout', false)); ?>>
                                                    <label for="enable_map_to_checkout" class="text">
                                                        <?php _e('Enable mapping field to checkout', 'wcpa-text-domain'); ?>
                                                        <br>
                                                        <small class="label"><?php _e('Enable this to show the mapping fields in field settings, Default : disable', 'wcpa-text-domain'); ?> </small>
                                                    </label>
                                                </li>
                                            </ul>
