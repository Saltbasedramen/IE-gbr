...
class WCPA_Backend extends WCPA_Order_Meta
{
    ...
    public function __construct($file = '', $version = '1.0.0')
    {
        ...
        // Fix Jet woo builder taxonomy compatibility
        add_filter("jet-woo-builder/integration/taxonomy-meta/object-types", array($this, 'jetwoo_compatibility_fix'), 10, 1);
...
//        str_replace( $find, $replace, $string ), $this
    ...
    public function print_global_data()
    {
        ...
        if ($this->check_woocommerce_active()) {
            ...
            $wcpa_global_vars['rest_base_url'] = get_rest_url( null, 'wcpa/v1');
            $wcpa_global_vars['enable_map_to_checkout'] = wcpa_get_option('enable_map_to_checkout', false);
    ...
    /**
     * Jet Woo Builder taxonomy compatibility fix
     * @since 4.1.5
     * @author rahulacodez
     */
    public function jetwoo_compatibility_fix($post_types = []) {
        $post_types[] = 'wcpa_pt_forms';
        return $post_types;
    }
