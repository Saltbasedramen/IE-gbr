...
class WCPA_Settings
{
    ...
    public function __construct()
    {
		...
		update_option('wcpa_activation_license_status','valid'); // Crack
        ...
        $this->settings = [
            ...
            'wcpa_disable_validation_scroll' => 'boolean',
            'wcpa_show_val_error_box' => 'boolean',
            ...
            'enable_map_to_checkout' => 'boolean',
