...
function green_planet_theme_color( $color ) {
	$cmsmasters_option = green_planet_get_global_options();

	$colors = array(
		'color' => $cmsmasters_option['green-planet_default_color'],
		'link' => $cmsmasters_option['green-planet_default_link'],
		'hover' => $cmsmasters_option['green-planet_default_hover'],
		'heading' => $cmsmasters_option['green-planet_default_heading'],
		'bg' => $cmsmasters_option['green-planet_default_bg'],
		'alternate' => $cmsmasters_option['green-planet_default_alternate'],
		'border' => $cmsmasters_option['green-planet_default_border'],
		'secondary' => $cmsmasters_option['green-planet_default_secondary'],
	);
...
function green_planet_hex_color( $color ) {
	$old_color = green_planet_theme_color( $color );
...
function green_planet_tribe_update_default_options() {
	...
	$new_global_elements = array(
		'event_title_color' => green_planet_hex_color( 'heading' ),
		'event_date_time_color' => green_planet_hex_color( 'color' ),
		'link_color' => green_planet_hex_color( 'link' ),
		'background_color_choice' => 'transparent',
		'background_color' => 'transparent',
		'accent_color' => green_planet_hex_color( 'secondary' ),
		'map_pin' => '',
	);
	...
	$new_single_event = array(
		...
		'post_title_color' => green_planet_hex_color( 'heading' ),
	...
	$new_tec_events_bar = array(
		'events_bar_text_color' => green_planet_hex_color( 'heading' ),
		'find_events_button_text_color' => green_planet_hex_color( 'bg' ),
		'events_bar_icon_color_choice' => 'default',
		'events_bar_icon_color' => green_planet_hex_color( 'heading' ),
		'find_events_button_color_choice' => 'custom',
		'find_events_button_color' => green_planet_hex_color( 'link' ),
		'events_bar_background_color_choice' => 'default',
		'events_bar_background_color' => green_planet_hex_color( 'bg' ),
		'view_selector_background_color_choice' => 'default',
		'view_selector_background_color' => green_planet_hex_color( 'bg' ),
		'events_bar_border_color_choice' => 'default',
		'events_bar_border_color' => green_planet_hex_color( 'border' ),
	);
	...
	$new_month_view = array(
		'days_of_week_color' => green_planet_hex_color( 'heading' ),
		'date_marker_color' => green_planet_hex_color( 'heading' ),
		'multiday_event_bar_color_choice' => 'default',
		'multiday_event_bar_color' => '#334aff',
		'grid_lines_color' => green_planet_hex_color( 'border' ),
		'grid_hover_color' => green_planet_hex_color( 'border' ),
		'grid_background_color_choice' => 'transparent',
		'grid_background_color' => green_planet_hex_color( 'color' ),
...
add_action( 'init', 'green_planet_tribe_update_default_options' );


/* The Events Calendar and related plugins: Add your own location for template file loading. */
function green_planet_tribe_additional_template_locations( string $file, string $template ) {
	$new_locations = array();

	if ( ! tribe_events_views_v2_is_enabled() ) {
		$new_locations['themes_root'] = trailingslashit( get_theme_root() ) . 'green-planet/tribe-events';
	}
...
add_filter( 'tribe_events_template', 'green_planet_tribe_additional_template_locations', 10, 2 );
...
function green_planet_tribe_events_register_styles_scripts() {
	// Styles
	if ( tribe_events_views_v2_is_enabled() ) {
		wp_enqueue_style( 'green-planet-tribe-events-v2-style', get_template_directory_uri() . '/tribe-events/cmsmasters-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/plugin-v2-style.css', array(), '1.0.0', 'screen' );
	} else {
...
function green_planet_tribe_events_layout($cmsmasters_layout) {
	if (
...
add_filter('cmsmasters_theme_page_layout_filter', 'green_planet_tribe_events_layout');
