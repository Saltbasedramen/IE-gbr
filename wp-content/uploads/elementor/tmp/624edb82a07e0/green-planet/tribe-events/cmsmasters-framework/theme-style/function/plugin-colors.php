...
function green_planet_tribe_events_colors($custom_css) {
...
/***************** Start {$title} Tribe Events Color Scheme Rules ******************/
	...
	{$rule}body .datepicker table tr td span.active.disabled[disabled], 
	{$rule}body .datepicker table tr td span.active.disabled:hover[disabled],
	{$rule}body .datepicker table thead th,
	...
	{$rule}#page ~ .datepicker table thead th:hover,
	{$rule}#page ~ .datepicker table thead th.dow {
	...
	{$rule}.tribe-events-grid .tribe-grid-header .tribe-week-today {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-planet' . '_' . $scheme . '_bg']) . ", .1);
	}
	...
	{$rule}table.tribe-events-calendar tbody td .tribe_events {
		border-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-planet' . '_' . $scheme . '_border']) . ", .3);
	}
...
add_filter('green_planet_theme_colors_secondary_filter', 'green_planet_tribe_events_colors');
