...
/***************** Start Tribe Events Font Styles ******************/
	...
	.tribe-events-grid .tribe-week-grid-hours {
		font-size:" . ((int) $cmsmasters_option['green-planet' . '_h6_font_font_size'] - 2) . "px;
		line-height:" . ((int) $cmsmasters_option['green-planet' . '_h6_font_line_height'] - 1) . "px;
	}
	
	.cmsmasters_single_event_meta .cmsmasters_event_meta_info_item_title {
		margin-top:" . ($cmsmasters_option['green-planet' . '_content_font_line_height'] - $cmsmasters_option['green-planet' . '_h6_font_line_height']) / 2 . "px;
		margin-bottom:" . ($cmsmasters_option['green-planet' . '_content_font_line_height'] - $cmsmasters_option['green-planet' . '_h6_font_line_height']) / 2 . "px;
	}
	/* Finish H6 Font */
	...
	table.tribe-events-calendar tbody td div[id*=tribe-events-daynum-],
	table.tribe-events-calendar tbody td div[id*=tribe-events-daynum-] a {
		font-size:" . ((int) $cmsmasters_option['green-planet' . '_small_font_font_size'] + 1) . "px;
	}
