...
$image_src = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'cmsmasters-project-thumb');
...
<div id="tribe-events-event-<?php echo esc_attr( $event_id ); ?>" class="<?php tribe_events_event_classes() ?> tribe_events" data-tribejson='<?php echo esc_attr( tribe_events_template_data( $post, $additional_data ) ); ?>'>
	<h3 class="tribe-events-month-event-title entry-title summary"><a href="<?php echo esc_url( $link ) ?>" class="url"><?php echo esc_html($title) ?></a></h3>
