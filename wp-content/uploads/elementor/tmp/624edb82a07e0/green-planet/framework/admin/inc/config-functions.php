...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['green-planet' . '_google_web_fonts']) && is_array($cmsmasters_option['green-planet' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['green-planet' . '_google_web_fonts'];
		...
		$fonts = array( 
			'' => esc_html__('None', 'green-planet'), 
			'local' => $local_fonts, 
			'web' => $google_web_fonts 
		);
		
		
		return apply_filters('green_planet_google_fonts_list_filter', $fonts);
	}
}
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = green_planet_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = green_planet_all_color_schemes_list();
