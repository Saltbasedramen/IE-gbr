...
if (!function_exists('green_planet_get_custom_profile_meta_fields')) {
function green_planet_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['green-planet' . '_profile_post_title']) && $cmsmasters_option['green-planet' . '_profile_post_title'] !== '') ? (($cmsmasters_option['green-planet' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['green-planet' . '_profile_post_details_title']) && $cmsmasters_option['green-planet' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['green-planet' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['green-planet' . '_profile_post_share_box']) && $cmsmasters_option['green-planet' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['green-planet' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'green-planet'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'green-planet'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'green-planet'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'green-planet'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'green-planet'), 
			'desc'	=> '', 
