...
if (!function_exists('green_planet_get_custom_page_meta_fields')) {
function green_planet_get_custom_page_meta_fields() {
	$cmsmasters_option = green_planet_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['green-planet' . '_layout']) && $cmsmasters_option['green-planet' . '_layout'] !== '') ? $cmsmasters_option['green-planet' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['green-planet' . '_header_overlaps']) && $cmsmasters_option['green-planet' . '_header_overlaps'] !== '') ? (($cmsmasters_option['green-planet' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'green-planet'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'green-planet'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'green-planet'), 
