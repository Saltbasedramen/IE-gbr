...
if (!function_exists('green_planet_get_custom_post_meta_fields')) {
function green_planet_get_custom_post_meta_fields() {
	$cmsmasters_option = green_planet_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['green-planet' . '_blog_post_layout']) && $cmsmasters_option['green-planet' . '_blog_post_layout'] !== '') ? $cmsmasters_option['green-planet' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['green-planet' . '_blog_post_title']) && $cmsmasters_option['green-planet' . '_blog_post_title'] !== '') ? (($cmsmasters_option['green-planet' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['green-planet' . '_blog_post_share_box']) && $cmsmasters_option['green-planet' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['green-planet' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['green-planet' . '_blog_post_author_box']) && $cmsmasters_option['green-planet' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['green-planet' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['green-planet' . '_blog_more_posts_box'])) ? $cmsmasters_option['green-planet' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'green-planet'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'green-planet'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'green-planet'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'green-planet'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'green-planet'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'green-planet'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'green-planet') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'green-planet'), 
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'green-planet'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'green-planet'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'green-planet'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'green-planet'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'green-planet'), 
			'desc'	=> '', 
