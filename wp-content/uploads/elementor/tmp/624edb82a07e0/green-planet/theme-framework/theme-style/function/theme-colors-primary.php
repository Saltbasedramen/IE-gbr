...
function green_planet_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_wrap_pagination .next.page-numbers:hover {
	...
	{$rule}.owl-pagination .owl-page.active {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_color']) . "
	}
	...
	{$rule}.cmsmasters_wrap_pagination .next.page-numbers,
	...
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-planet' . '_' . $scheme . '_link']) . ", .95);
	}
	
	{$rule}.cmsmasters_profile_horizontal .cmsmasters_img_social_wrap .profile_social_icons {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-planet' . '_' . $scheme . '_link']) . ", .75);
	}
	...
	{$rule}select:focus,
	{$rule}.post_nav {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_wrap_pagination ul li .page-numbers:hover > span:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.cmsmasters_mailpoet input[type=submit],
	{$rule}.cmsmasters-form-builder .form_info.submit_wrap .cmsmasters_button,
	{$rule}.profiles .cmsmasters_social_icon:hover,
	...
	{$rule}.woocommerce-cart-form__cart-item .product-subtotal span,
	{$rule}.cmsmasters_post_cont_info a .cmsmasters_post_date {
	...
	{$rule}.cmsmasters_items_filter_wrap .cmsmasters_items_sort_but:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_heading']) . "
	}
	
	{$rule}.cmsmasters_pricing_table .cmsmasters_pricing_item.pricing_best .cmsmasters_pricing_item_inner {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}.cmsmasters_project_puzzle .cmsmasters_project_header a:hover,
	{$rule}.cmsmasters_project_puzzle .cmsmasters_project_category a,
	{$rule}.cmsmasters_project_puzzle .cmsmasters_project_category a:hover,
	...
	{$rule}.cmsmasters_project_puzzle .cmsmasters_likes a.active:hover {
	...
	{$rule}#page .woocommerce-form__input-checkbox + span:before,
	{$rule}input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]),
	{$rule}textarea,
	{$rule}option,
	{$rule}.cmsmasters_button,
	...
	{$rule}.cmsmasters_cat_color:before {
	...
	{$rule}.cmsmasters_slider_post_header h2 a:hover,
	{$rule}.cmsmasters_post_read_more:hover,
	{$rule}.cmsmasters_post_header  h2 a:hover,
	{$rule}.cmsmasters_post_header  h3 a:hover,
	{$rule}.cmsmasters_profile_title a:hover,
	{$rule}.cmsmasters_profile_vertical .cmsmasters_profile_header .cmsmasters_profile_subtitle,
	{$rule}.cmsmasters_slider_project_header a:hover,
	{$rule}.cmsmasters_slider_project .cmsmasters_slider_project_cont_info *,
	{$rule}.cmsmasters_project_header a:hover,
	{$rule}.cmsmasters_mailpoet input[type=submit]:hover,
	{$rule}.cmsmasters_likes a.active:hover,
	{$rule}.cmsmasters_likes a.active,
	{$rule}.cmsmasters_post_cont_info a .cmsmasters_post_date:hover {
	...
	{$rule}#page .woocommerce-form__input-checkbox + span:after, 
	...
	{$rule}.cmsmasters_button:hover,
	{$rule}.button:hover,
	{$rule}.cmsmasters_project_puzzle .button,
	{$rule}input[type=submit],
	{$rule}input[type=button],
	{$rule}button:hover,
	{$rule}.cmsmasters-form-builder .form_info.submit_wrap .cmsmasters_button,
	...
	{$rule}.cmsmasters_open_post .cmsmasters_owl_slider .owl-pagination > div.active,
	{$rule}.cmsmasters_mailpoet input[type=submit],
	{$rule}.cmsmasters_mailpoet input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]):focus {
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['green-planet' . '_' . $scheme . '_secondary']) . "
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['green-planet' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('green_planet_theme_colors_primary_filter', $custom_css);
}
