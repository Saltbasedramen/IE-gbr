...
<?php green_planet_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php green_planet_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<div id="middle">
<?php 
green_planet_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = green_planet_theme_page_layout_scheme();
