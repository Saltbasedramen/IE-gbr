...
function green_planet_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.woocommerce .product_list_widget li a:hover, 
	...
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.woocommerce-checkout-payment .payment_methods .payment_box:after {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.select2-container.select2-container--focus .select2-dropdown--below {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.select2-container.select2-container--focus .select2-dropdown--above {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['green-planet' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.cmsmasters_product_add_inner .added_to_cart:hover {
	...
	{$rule}.comment-form-rating .stars > span {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['green-planet' . '_' . $scheme . '_secondary']) . ", .3);
	}
...
add_filter('green_planet_theme_colors_secondary_filter', 'green_planet_woocommerce_colors');
