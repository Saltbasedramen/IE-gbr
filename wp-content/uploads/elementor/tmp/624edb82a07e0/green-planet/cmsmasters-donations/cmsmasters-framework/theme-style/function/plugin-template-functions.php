...
function green_planet_donations_header_top_button($cmsmasters_option) {
	if (
		isset($cmsmasters_option['green-planet' . '_header_top_line_donations_but']) && 
		$cmsmasters_option['green-planet' . '_header_top_line_donations_but'] &&
		isset($cmsmasters_option['green-planet' . '_header_top_line_donations_but_text']) && 
		$cmsmasters_option['green-planet' . '_header_top_line_donations_but_text'] != '' 
	) {
		$cmsmasters_donations_form_page = get_option('cmsmasters_donations_form_page');
		
		$cmsmasters_donations_button_link = (isset($cmsmasters_option['green-planet' . '_header_top_line_donations_but_link']) && $cmsmasters_option['green-planet' . '_header_top_line_donations_but_link'] != '' ? $cmsmasters_option['green-planet' . '_header_top_line_donations_but_link'] : get_permalink($cmsmasters_donations_form_page));
		
		
		echo '<div class="header_top_donation_but_wrap">' . 
			'<a href="' . esc_url($cmsmasters_donations_button_link) . '" class="header_top_donation_but"><span>' . esc_html($cmsmasters_option['green-planet' . '_header_top_line_donations_but_text']) . '</span></a>' . 
		'</div>';
	}
}

add_action('cmsmasters_before_header_top', 'green_planet_donations_header_top_button');


/* Header Mid Donations Button */
function green_planet_donations_header_mid_button($cmsmasters_option) {
	if (
		isset($cmsmasters_option['green-planet' . '_header_donations_but']) && 
		$cmsmasters_option['green-planet' . '_header_donations_but'] && 
		isset($cmsmasters_option['green-planet' . '_header_donations_but_text']) && 
		$cmsmasters_option['green-planet' . '_header_donations_but_text'] != '' && 
		$cmsmasters_option['green-planet' . '_header_styles'] != 'c_nav'
	) {
		$cmsmasters_donations_form_page = get_option('cmsmasters_donations_form_page');
		
		$cmsmasters_donations_button_link = (isset($cmsmasters_option['green-planet' . '_header_donations_but_link']) && $cmsmasters_option['green-planet' . '_header_donations_but_link'] != '' ? $cmsmasters_option['green-planet' . '_header_donations_but_link'] : get_permalink($cmsmasters_donations_form_page));
			...
			'<div class="header_donation_but_wrap_inner">' . 
				'<div class="header_donation_but">' . 
					'<a href="' . esc_url($cmsmasters_donations_button_link) . '" class="cmsmasters_button">' . 
						'<span>' . esc_html($cmsmasters_option['green-planet' . '_header_donations_but_text']) . '</span>' . 
					'</a>' . 
				'</div>' . 
			'</div>' . 
		'</div>';
...
add_action('cmsmasters_after_logo', 'green_planet_donations_header_mid_button');



/********** Template Functions for Campaign **********/
/* Get Campaigns Heading Function */
function green_planet_donations_campaign_heading($cmsmasters_id, $tag = 'h1', $link = true, $show = true) { 
...
function green_planet_donations_campaign_date($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		$out = '<span class="cmsmasters_campaign_date">' . 
			esc_html__('On', 'green-planet') . ' ' . 
		...
		if ($cmsmasters_option['green-planet' . '_donations_campaign_date']) {
			$out .= '<span class="cmsmasters_campaign_date">' . 
				esc_html__('On', 'green-planet') . ' ' . 
				'<abbr class="published" title="' . esc_attr(get_the_date()) . '">' . 
					get_the_date() . 
...
function green_planet_donations_campaign_author($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		$out = '<span class="cmsmasters_campaign_user_name">' . 
			esc_html__('By', 'green-planet') . ' ' . 
			'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Posts by', 'green-planet') . ' ' . get_the_author_meta('display_name') . '" class="vcard author"><span class="fn" rel="author">' . get_the_author_meta('display_name') . '</span></a>' . 
		'</span>';
	} elseif ($template_type == 'post') {
		$cmsmasters_option = green_planet_get_global_options();
		...
		if ($cmsmasters_option['green-planet' . '_donations_campaign_author']) {
			$out .= '<span class="cmsmasters_campaign_user_name">' . 
				esc_html__('By', 'green-planet') . ' ' . 
				'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Posts by', 'green-planet') . ' ' . get_the_author_meta('display_name') . '" class="vcard author"><span class="fn" rel="author">' . get_the_author_meta('display_name') . '</span></a>' . 
			'</span>';
...
function green_planet_donations_campaign_category($cmsmasters_id, $taxonomy, $template_type = 'page', $show = true) {
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['green-planet' . '_donations_campaign_cat']) {
				$out .= '<span class="cmsmasters_campaign_category">' . 
					get_the_term_list($cmsmasters_id, $taxonomy, esc_html__('In', 'green-planet') . ' ', ', ', '') . 
				'</span>';
			}
		}
...
function green_planet_donations_campaign_tags($cmsmasters_id, $taxonomy, $template_type = 'page', $show = true) {
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['green-planet' . '_donations_campaign_tag']) {
				$out .= '<span class="cmsmasters_campaign_tags">' . 
					get_the_term_list($cmsmasters_id, $taxonomy, esc_html__('Tags', 'green-planet') . ' ', ', ', '') . 
				'</span>';
			}
		}
...
function green_planet_donations_campaign_exc_cont($content = '', $word_count = 55, $show = true) {
	if ($content != '') {
...
function green_planet_donations_campaign_like($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		...
		if ($cmsmasters_option['green-planet' . '_donations_campaign_like']) {
			$out = cmsmasters_like(false);
		}
	}
...
function green_planet_donations_campaign_comments($template_type = 'page', $show = true) {
	if (comments_open()) {
		if ($template_type == 'page') {
			$out = '<span class="cmsmasters_comments">' . 
				'<a class="cmsmasters_post_comments cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'green-planet') . ' ' . get_the_title() . '">' . 
			...
			if ($cmsmasters_option['green-planet' . '_donations_campaign_comment']) {
				$out = '<span class="cmsmasters_comments">' . 
					'<a class="cmsmasters_post_comments cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'green-planet') . ' ' . get_the_title() . '">' . 
						'<span>' . get_comments_number() . '</span>' . 
					'</a>' . 
...
function green_planet_donations_campaign_rest_amount($cmsmasters_id, $show = true) {
	...
	$out = '<span class="cmsmasters_campaign_rest_amount">' . 
		sprintf(esc_attr__('%s to go', 'green-planet'), cmsmasters_donations_currency($togo_number)) . 
	'</span>';
...
function green_planet_donations_campaign_target($cmsmasters_id, $show = true) {
	...
	$out = '<div class="cmsmasters_campaign_target">' . 
		'<div class="cmsmasters_campaign_target_inner">' . 
			...
			'<h3 class="cmsmasters_campaign_target_title">' . esc_html__('Campaign Target', 'green-planet') . '</h3>' . 
		'</div>' . 
	'</div>';
...
function green_planet_donations_campaign_donations_count($cmsmasters_id, $show = true) {
	...
	$out = '<div class="cmsmasters_campaign_donations_count">' . 
		'<div class="cmsmasters_campaign_donations_count_inner">' . 
			...
			'<h3 class="cmsmasters_campaign_donations_count_title">' . ($funds_number == 1 ? esc_html__('Donation', 'green-planet') : esc_html__('Donations', 'green-planet')) . '</h3>' . 
		'</div>' . 
	'</div>';
...
function green_planet_donations_campaign_donated($cmsmasters_id, $template_type = 'page', $layout_type = 'horizontal', $togo = true, $show = true) {
	$target = get_the_campaign_target($cmsmasters_id);
	...
	if ($template_type == 'page') {
		if ($layout_type == 'horizontal') {
				...
				'<div class="cmsmasters_stats stats_mode_bars stats_type_horizontal">' . 
					'<div class="cmsmasters_stat_wrap">' .
						'<div class="cmsmasters_stat_title_wrap">' . 
							'<span class="cmsmasters_stat_title">' . esc_html__('Donated', 'green-planet') . '</span>' .
						...
						'</div>' . 
						'<span class="cmsmasters_stat_subtitle">' . sprintf(esc_attr__('%s to go', 'green-planet'), cmsmasters_donations_currency($togo_number)) . '</span>' .					 
					'</div>' . 
				'</div>' . 
			'</div>';
			...
			$out = '<div class="cmsmasters_campaign_donated_percent">' . 
				do_shortcode('[cmsmasters_stats mode="circles" count="1" shortcode_id="' . esc_attr($cmsmasters_id) . '"][cmsmasters_stat shortcode_id="' . esc_attr($cmsmasters_id) . '" progress="' . $progress . '"]' . esc_html__('Donated', 'green-planet') . '[/cmsmasters_stat][/cmsmasters_stats]') . 
			'</div>';
		}
	} elseif ($template_type == 'post') {		
		$out = '<div class="cmsmasters_campaign_donated">' . 
			'<div class="cmsmasters_campaign_donated_inner">' . 
				'<div class="cmsmasters_stats stats_mode_bars stats_type_horizontal">' . 
					'<div class="cmsmasters_stat_wrap">' . 
						(($togo) ? '<h6 class="cmsmasters_stat_subtitle">' . sprintf(esc_attr__('%s to go', 'green-planet'), cmsmasters_donations_currency($togo_number)) . '</h6>' : '') . 
						'<div id="cmsmasters_stat_' . esc_attr($cmsmasters_id) . '" class="cmsmasters_stat" data-percent="' . esc_attr($progress) . '">' . 
							'<div class="cmsmasters_stat_inner"></div>' . 
						'</div>' . 
						'<div class="cmsmasters_stat_title_wrap">' . 
...
function green_planet_donations_campaign_donated_open_style() {
	...
	if (get_post_type($campaign_id) == 'campaign') {
		...
		if ($shortcode_styles != '') {
			wp_add_inline_style('green-planet-style', $shortcode_styles);
		}
	}
}

add_action('wp_enqueue_scripts', 'green_planet_donations_campaign_donated_open_style');


/* Get Campaign Donate Button Function */
function green_planet_donations_campaign_donate_button($cmsmasters_id, $show = true) {
	$cmsmasters_donations_form_page = get_option('cmsmasters_donations_form_page');
	...
	if ($cmsmasters_campaign_read_more == '') {
		$cmsmasters_campaign_read_more = esc_html__('Donate Now!', 'green-planet');
	}
...
function green_planet_donations_related($tag = 'h3', $title = '', $no_title = '', $box_type = false, $tgsarray = null, $items_number = 5, $pause_time = 5, $type = 'post', $taxonomy = null) {
	if ( 
		...
		echo "<aside class=\"cmsmasters_single_slider cmsmasters_single_slider_campaign\">";
			echo "<" . esc_html($tag) . " class=\"cmsmasters_single_slider_title\">" . 
				($title != '' ? esc_html($title) : esc_html__('More items', 'green-planet')) . 
			"</" . esc_html($tag) . ">";
			...
			if ($r_query->have_posts()) {
						...
						while ($r_query->have_posts()) : $r_query->the_post();
							echo "<div class=\"cmsmasters_owl_slider_item cmsmasters_single_slider_item\">
								<div class=\"cmsmasters_single_slider_item_outer\">";
									...
									green_planet_thumb(get_the_ID(), 'cmsmasters-project-thumb', true, false, true, false, true, true, false, false, false, 'cmsmasters_theme_icon_image');
									...
									echo "<div class=\"cmsmasters_single_slider_item_inner\">
										...
										green_planet_donations_campaign_donated(get_the_ID(), 'page');
				...
				echo "<h5 class=\"cmsmasters_single_slider_no_items\">" . 
					($no_title != '' ? esc_html($no_title) : esc_html__('No items found', 'green-planet')) . 
				"</h5>";
			}
...
function green_planet_donations_related_styles() {
	...
	if (get_post_type($single_campaign_id) == 'campaign') {
		...
		$items_number = $cmsmasters_option['green-planet' . '_donations_more_campaigns_count'];
...
add_action('wp_enqueue_scripts', 'green_planet_donations_related_styles');


/********** Template Functions for Donation **********/
/* Get Donations Heading Function */
function green_planet_donations_donation_heading($cmsmasters_id, $tag = 'h1', $link = true, $show = true) { 
		...
		'<' . $tag . ' class="cmsmasters_donation_title entry-title">' . 
			($link ? '<a href="' . esc_url(get_permalink()) . '">' : '');
				...
				if (
					...
					$out .= esc_html__('Anonym', 'green-planet');
				}
...
function green_planet_donations_donation_amount_currency($cmsmasters_id, $template_type = 'page', $show = true) { 
	if (get_the_donation_amount_currency($cmsmasters_id)) {
		if ($template_type == 'page') {
			...
			$out = '<span class="cmsmasters_donation_amount_title">' . esc_html__('Donated', 'green-planet') . '</span>' . 
...
/* Get Donation Amount Currency Function */
function green_planet_donations_donation_campaign($cmsmasters_id, $template_type = 'page', $show = true) { 
...
function green_planet_donations_donation_details($cmsmasters_id, $show = true) {
	$out = '';
				...
				'<div class="cmsmasters_row_margin">' . 
					'<div class="cmsmasters_column one_half">';
						...
						if (get_the_donator_meta('firstname', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('First Name:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('lastname', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Last Name:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('email', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Email:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('company', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Company:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('phone', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Phone:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('website', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Website:', 'green-planet') . ' </span>' . 
					...
					'<div class="cmsmasters_column one_half">';
						...
						if (get_the_donator_meta('address', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Address:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('city', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('City:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('state', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('State / Province:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('zip', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Postal / Zip Code:', 'green-planet') . ' </span>' . 
						...
						if (get_the_donator_meta('country', $cmsmasters_id)) {
							$out .= '<div class="cmsmasters_donation_details_item">' . 
								'<span class="cmsmasters_donation_details_item_title">' . esc_html__('Country:', 'green-planet') . ' </span>' . 
